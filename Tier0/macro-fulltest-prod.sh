...
TEMPDIR=`mktemp -d /scratch/tmpPIXELS/tempXXXX`
...
#set analysis paths
ANALYSISPATH=/home/cmsweb/Analysis/moreweb-prod-Jun16/MoReWeb/Analyse
...
#
#ADDDIR=`ls -1d *`
cat $CONFIGPATHTEMPLATE/PathsTemplate.cfg |sed "s#DIRECTORY#$TEMPDIR/INPUT#g" | sed "s#OUTGLOBAL#$GLOBALDIR#g"  | sed "s#PATHOVERVIEW#$TEMPDIR#g"  > $CONFIGPATH/Paths.cfg 
