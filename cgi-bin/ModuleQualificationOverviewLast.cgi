...
# enable debugging
#!/usr/bin/env python
print "Location: /cgi-bin/rawPredefinedView.cgi?viewNumber=10"
print
exit(0)
...
#	,"\"%d\"%o.fullmoduletestsT_ID"
#	,"\"%s\"%o.TEST_ID" #session.session.CENTER"
...
objects = pdb.store.find(FullModule) # ,objType.TEST_ID==88)
