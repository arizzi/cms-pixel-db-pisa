...
evals = ["\"%s (<a href=\"%(o.FULLMODULE_ID)+pfn(o."+analysisToUse+".data.PFNs)+\">last analysis results</a>)\"","datetime.fromtimestamp(float(o.TIMESTAMP)).isoformat()","o.TEMPNOMINAL","o."+analysisToUse+".GRADE"
...
headers = ["Module ID","Date","Temperature","Grade","Noisy","ROCs >1%","PhCal","Trimming"]
i =0 
