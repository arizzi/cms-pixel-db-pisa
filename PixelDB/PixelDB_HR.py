...
#with fixed width fields
      ...
      def insertFullModuleHRTestFromMoreWeb (self, HighRateDataModule, , HighRateDataAggr, HighRateDataAllNoise, HighRateDataInterp
                                             ,HighRateDataRoc
                                             ,HighRateDataAggrRoc
...
#            print "HighRateDataInterpRoc",HighRateDataInterpRoc
            ...
            for rate, payload in HighRateDataInterp.iteritems():
                  ...
                  interpEff[rate] = -99 # HighRateDataModule['InterpEff']
                  
            #
            # now Noise
            #
            #
            for rate, payload in HighRateDataNoise.iteritems():
